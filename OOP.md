...
- Создать репозиторий с тест кейсами, изначально репозиторий пустой
- создать 3 кейса разного приоритета;
- Добавить все 3 тест кейса в репозиторий
...
- вывести в консоль названия тест кейсов из репозитория
